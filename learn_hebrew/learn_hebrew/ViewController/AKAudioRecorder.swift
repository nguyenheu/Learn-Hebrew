...
class AKAudioRecorder: NSObject {
        ...
        if let audioRecorder = audioRecorder{
            if !isRecording {
                do{
                    ...
                    learn_hebrew.debugLog("Recording")
    ...
    func stopRecording(completion: (() -> Void)? = nil){
        if audioRecorder != nil{
            ...
            do {
                ...
                isRecording = false
                learn_hebrew.debugLog("Recording Stopped")
                } catch {
    ...
    func stopPlaying(){
        ...
        isPlaying = false
        learn_hebrew.debugLog("Stopped playing")
    }
    ...
    func deleteRecording(name: String){
        ...
        if manager.fileExists(atPath: path.path) {
            ...
            do {
                ...
                learn_hebrew.debugLog("Recording Deleted")
            } catch {
...
extension AKAudioRecorder : AVAudioRecorderDelegate{
    func audioRecorderDidFinishRecording(_ recorder: AVAudioRecorder, successfully flag: Bool) {
        ...
        switch flag {
        case true:
            learn_hebrew.debugLog("record finish")
        case false:
            learn_hebrew.debugLog("record erorr")
        }
            }
    func audioRecorderEncodeErrorDidOccur(_ recorder: AVAudioRecorder, error: Error?) {
        isRecording = false
        learn_hebrew.debugLog(error?.localizedDescription ?? "Error occured while encoding recorder")
    }
}
...
extension AKAudioRecorder: AVAudioPlayerDelegate{
    func audioPlayerDidFinishPlaying(_ player: AVAudioPlayer, successfully flag: Bool) {
        isPlaying = false
        learn_hebrew.debugLog("playing finish")
    }
    
    func audioPlayerDecodeErrorDidOccur(_ player: AVAudioPlayer, error: Error?) {
        isPlaying = false
        learn_hebrew.debugLog(error?.localizedDescription ?? "Error occured while encoding player")
    }
}
