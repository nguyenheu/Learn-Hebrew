...
class GeoQuizVC: UIViewController {
...
extension GeoQuizVC: UICollectionViewDelegate, UICollectionViewDataSource {
...
extension GeoQuizVC: UICollectionViewDelegateFlowLayout {
